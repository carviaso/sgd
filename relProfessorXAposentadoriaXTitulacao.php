...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta name="keywords" content="professor x aposentadoria x titulacao, relat처rio" />
        <meta name="description" content="Esta 죊ina de relatios de professores x aposentadoria x titulacao do sistema de geo de docentes" />
    ...
    <body>
        ...
        <?php include 'include/header.php'; ?>
            ...
            <div id="page">
                <div id="content">
                    <div id="welcome">
                        <h1>Relatrio de Professores X Aposentadoria X Titula즣</h1>
                        ...
                        //Se foi clicado no bot찾o "Visualizar"
                        if (isset($_POST['submit'])) {
                            ...
                            echo '<p>';
                            echo '<div id="LOperadorLogicoQuantidadeAnos">Operador l처gico sobre os anos para a aposentadoria</div>';
                            ...
                            echo '<p>';
                            echo '<div id="LOperadorLogicoTipoTitulacao">Operador l처gico sobre o tipo de titulo</div>';
