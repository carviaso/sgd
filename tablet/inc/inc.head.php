<head>
	...
	<link rel="stylesheet" href="./public/jqm/jqm-docs.mini.css"/>
	...
	<script src="./public/jqm/themeswitcher/jquery.mobile.themeswitcher.mini.js"></script>
	<script src="./public/jqm/jqm-docs.js"></script>
	
	<script src="./public/js/master.js?<?php echo filemtime('./public/js/master.js'); ?>"></script>
	<script src="./public/js/jquery.maskedinput-1.3.min.js?<?php echo filemtime('./public/js/jquery.maskedinput-1.3.min.js'); ?>"></script>
	<script src="./public/js/zend.min.parte.js?<?php echo filemtime('./public/js/zend.min.parte.js'); ?>"></script>
