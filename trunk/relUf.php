...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Relatório de UFs</title>
        <meta name="keywords" content="uf, relatório" />
        <meta name="description" content="Esta é página de relatórios das UFs do sistema de gestão de docentes" />
                    ...
                    <div id="welcome">
                        ...
                        <table class="aatable">
                            ...
                            for($index=0; $index < count($result); $index++) {
                                ...
                                echo "<td>".$depData['id_uf']."</td>";
                                echo "<td>".$depData['nome']."</td>";
                                echo "<td>".$depData['sigla']."</td>";

                                $result2 = $proxy->get_pais( $depData['id_pais'] );
                                $depData2 = $result2[0];
